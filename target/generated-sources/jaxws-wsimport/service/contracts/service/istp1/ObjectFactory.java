...
public class ObjectFactory {
    ...
    private final static QName _InformarCreditoOtorgadoIdentificadorCredito_QNAME = new QName("http://ISTP1.Service.Contracts.Service", "identificadorCredito");
    private final static QName _InformarCreditoOtorgadoCodigoFinanciera_QNAME = new QName("http://ISTP1.Service.Contracts.Service", "codigoFinanciera");
    ...
    public JAXBElement<String> createInformarCreditoOtorgadoIdentificadorCredito(String value) {
        return new JAXBElement<String>(_InformarCreditoOtorgadoIdentificadorCredito_QNAME, String.class, InformarCreditoOtorgado.class, value);
    }
    ...
    public JAXBElement<String> createInformarCreditoOtorgadoCodigoFinanciera(String value) {
        return new JAXBElement<String>(_InformarCreditoOtorgadoCodigoFinanciera_QNAME, String.class, InformarCreditoOtorgado.class, value);
    }
    ...
    public JAXBElement<String> createObtenerEstadoClienteCodigoFinanciera(String value) {
        return new JAXBElement<String>(_InformarCreditoOtorgadoCodigoFinanciera_QNAME, String.class, ObtenerEstadoCliente.class, value);
    }
    ...
    public JAXBElement<String> createInformarCreditoFinalizadoIdentificadorCredito(String value) {
        return new JAXBElement<String>(_InformarCreditoOtorgadoIdentificadorCredito_QNAME, String.class, InformarCreditoFinalizado.class, value);
    }
    ...
    public JAXBElement<String> createInformarCreditoFinalizadoCodigoFinanciera(String value) {
        return new JAXBElement<String>(_InformarCreditoOtorgadoCodigoFinanciera_QNAME, String.class, InformarCreditoFinalizado.class, value);
    }
